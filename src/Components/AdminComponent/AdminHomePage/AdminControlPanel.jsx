  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
      ...
      <div className="bg-gray-800 p-4 rounded-lg">
        ...
        <button className="mt-3 bg-gray-700 hover:bg-gray-600 px-4 py-1 rounded text-sm">Manage</button>
      </div>
      ...
      <div className="bg-gray-800 p-4 rounded-lg">
        ...
        <button className="mt-3 bg-gray-700 hover:bg-gray-600 px-4 py-1 rounded text-sm">View All</button>
      </div>
      ...
      <div className="bg-gray-800 p-4 rounded-lg">
        ...
        <button className="mt-3 bg-gray-700 hover:bg-gray-600 px-4 py-1 rounded text-sm">Configure</button>
      </div>
    </div>
  );
};
