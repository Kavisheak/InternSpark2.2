      ...
      <div className="w-full max-w-md bg-slate-800/80 backdrop-blur-md border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center px-4 py-3 border border-slate-600 rounded-lg bg-slate-700/50 text-white hover:bg-slate-700 transition-colors"
            >
